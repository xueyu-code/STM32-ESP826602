...
* @{
*/
#define PRODUCT_KEY "a9056ff91cf149d6b9571f8542b8900b"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "4e072fd0184543d9ba186e487d6b99cb"
...
#define MQ2_flag_BYTEOFFSET                    13
#define MQ2_flag_BITOFFSET                     0
#define MQ2_flag_LEN                           1
#define MQ9_flag_BYTEOFFSET                    13
#define MQ9_flag_BITOFFSET                     1
#define MQ9_flag_LEN                           1
#define MQ5_flag_BYTEOFFSET                    13
...
#define MQ9_data_RATIO                         1
#define MQ9_data_ADDITION                      0
#define MQ9_data_MIN                           0
#define MQ9_data_MAX                           500
#define MQ5_data_RATIO                         1
#define MQ5_data_ADDITION                      0
#define MQ5_data_MIN                           0
#define MQ5_data_MAX                           500
/**@} */
...
typedef struct {
  ...
  uint32_t valueMQ9_data;
  uint32_t valueMQ5_data;
  bool valueMQ2_flag;
  bool valueMQ9_flag;
  bool valueMQ5_flag;
} dataPoint_t;
...
typedef struct {
  ...
  uint16_t valueMQ9_data;
  uint16_t valueMQ5_data;
